...
# set uuid
wget -O /etc/xray/xray.json https://raw.githubusercontent.com/Rerechan02/nani/main/xray.json
wget -O /etc/xray/v2ray.json https://raw.githubusercontent.com/Rerechan02/nani/main/v2ray.json
clear
...
clear
cd /usr/local/bin
wget https://raw.githubusercontent.com/Rerechan02/nani/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
cd /etc/systemd/system
wget https://raw.githubusercontent.com/Rerechan02/nani/main/service.zip
unzip service.zip
rm -fr service.zip
systemctl daemon-reload
